...
var RecaptchaStr_pt = {
    ...
    instructions_audio: "Escreva os 8 números:",
    help_btn: "Ajuda",
    incorrect_try_again: "Incorreto. Tenta outra vez."
};
var RecaptchaStr_ru = {
...
var Recaptcha = {
    ...
    $: function(id) {
        if (typeof(id) === "string") {
            if (Recaptcha.context) {
                var _context = document.getElementById(Recaptcha.context).getElementsByTagName('*');
    ...
    create: function(public_key, context, options) {
        Recaptcha.destroy();
        if (context) {
            Recaptcha.context = context
            Recaptcha.widget = Recaptcha.$('recaptcha_image');
        }
    ...
    _add_css: function(css) {
        ...
        if (styleTag.styleSheet) {
            ...
            if (navigator.appVersion.indexOf("MSIE 5") != -1) {
                // IE 5 crashes if we add a style tag to the DOM
    ...
    _set_style: function(css) {
        ...
        ".recaptcha_nothad_incorenviar_item_faleconoscorect_sol .recaptcha_only_if_incorrect_sol" +
    ...
    _finish_widget: function() {
        ...
        var theme = $OPT.theme;
        var _widget = Recaptcha.widget || $('recaptcha_image');
        ...
        _widget.style.width = '300px';
        _widget.style.height = '57px';
    ...
    _set_challenge: function(new_challenge, type)
    {
        ...
        if (type == 'audio') {
            _widget.innerHTML = Recaptcha.getAudioCaptchaHtml();
        } else if (type == 'image') {
            ...
            _widget.innerHTML = "<img style='display:block;' height='57' width='300' src='" + imageurl + "'/>";
        }
    ...
    _displayerror: function(msg) {
        ...
        _widget.innerHTML = '';
        _widget.appendChild(document.createTextNode(msg));
    },
